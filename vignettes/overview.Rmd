...
`colourpicker` gives you a colour picker widget that can be used in different contexts in R. Most of the functionality here is taken from straight from [`shinyjs`](https://github.com/daattali/shinyjs) in order to make the colour picker a standalone package.
